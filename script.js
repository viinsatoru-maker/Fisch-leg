...
const gameData = {
    ...
    depthGear: {
        ...
        turtleHat: false,
        maskOfSatoshi: false,
        // NEW: Ghost Ship untuk akses dungeon
        ghostShip: false
    },
    backpack: [],
    selectedFish: [],
    ...
    // ==================== NEW: DUNGEON DATA ====================
    dungeon: {
        // Item wajib untuk buka dungeon
        unlocked: false, // Jadi true kalau punya Ghost Ship + One Ring
        ...
        // Equipment untuk ikan di dungeon
        fishEquipment: {
            equippedFish: null, // Index ikan di backpack yang dipakai
            weapon: null, // ID senjata
            armor: null // ID armor
        },
        
        // Progress dungeon (bos yang sudah dikalahkan per level)
        dungeonProgress: {
...
const GAME_VERSIONS = {
    ...
    features: {
        ...
        9: "⚔️ DUNGEON UPDATE! Ghost Ship, One Ring, 12 Bosses (Morgoth, Sauron, Valar)"
    }
};
...
const atlantisSpot = {
    ...
    fishes: [
        ...
        { id: 702, name: "Neptunus", rarity: "special", chance: 0.1, price: 50000, emoji: "🧜‍♂️", spot: "atlantis" }
    ]
};
...
const depthGear = [
    ...
    // NEW: Ghost Ship untuk akses dungeon
    { id: "ghostShip", name: "👻 Ghost Ship", description: "Kapal hantu untuk mengarungi dungeon (WAJIB untuk buka dungeon)", price: 500, currency: "diamonds", emoji: "🚢👻" }
];
...
const secretFishPool = [
    ...
    { id: 702, name: "Neptunus", emoji: "🧜‍♂️", price: 50000, rarity: "special", spot: "atlantis" }
];
...
const rods = [
    ...
    { id: 13, name: "Timothy Rod", luck: 15000, price: 500, currency: "diamonds", owned: false, emoji: "⏰" },
...
const baits = [
    ...
    { id: 9, name: "Bitcoin Bait", luck: 10000, price: 0, owned: false, fromQuest: true, emoji: "₿" },
...
const pets = [
    ...
    { id: 3, name: "Ayam Exp", description: "+10 EXP Gamepass setiap memancing", effect: { type: "exp_bonus", value: 10 }, price: 10000, currency: "coins", emoji: "🐓" },
...
const mysteryBoxes = {
    ...
    secret: {
        ...
        items: [
            ...
            { type: "rod", id: 10, name: "Tyo Rod", chance: 5, emoji: "👑" }
        ]
    }
};
...
// ==================== DUNGEON ARMOR & WEAPONS ====================
const dungeonWeapons = [
    { id: 1, name: "Pisau Karang", attack: 10, price: 2000, currency: "coins", emoji: "🔪", description: "Senjata basic untuk pemula" },
    { id: 2, name: "Tombak Nelayan", attack: 25, price: 5000, currency: "coins", emoji: "🔱", description: "Tombak tajam untuk melawan monster" },
    { id: 3, name: "Pedang Laut", attack: 50, price: 15000, currency: "coins", emoji: "⚔️", description: "Pedang bertenaga ombak" },
    { id: 4, name: "Trident Emas", attack: 100, price: 50, currency: "diamonds", emoji: "🔱✨", description: "Senjata legendaris dari dasar laut" },
    { id: 5, name: "Excalibur Ikan", attack: 250, price: 200, currency: "diamonds", emoji: "🗡️👑", description: "Senjata terkuat untuk dungeon" }
];

const dungeonArmors = [
    { id: 1, name: "Baju Sisik", defense: 5, price: 1500, currency: "coins", emoji: "🛡️", description: "Armor dari sisik ikan" },
    { id: 2, name: "Zirah Kerang", defense: 15, price: 4000, currency: "coins", emoji: "🐚", description: "Perlindungan dari cangkang kerang" },
    { id: 3, name: "Baju Baja", defense: 30, price: 10000, currency: "coins", emoji: "🛡️⚙️", description: "Armor baja kokoh" },
    { id: 4, name: "Jubah Hantu", defense: 60, price: 40, currency: "diamonds", emoji: "👻", description: "Jubah misterius dari kapal hantu" },
    { id: 5, name: "Armor Naga", defense: 150, price: 150, currency: "diamonds", emoji: "🐲🛡️", description: "Armor legendaris dengan kekuatan naga" }
];

// ==================== DUNGEON BOSSES ====================
const dungeonBosses = [
    // LEVEL 1 DUNGEON - Pantai Berbisik
    {
        id: 101,
    ...
    // LEVEL 4 DUNGEON - Dungeon Terakhir (Boss Besar)
    {
        id: 401,
        name: "Morgoth",
        emoji: "👑🔥",
...
const dungeonLevels = [
    {
        id: 1,
        name: "🐚 Pantai Berbisik",
        description: "Dungeon pemula, ombak berbisik membawa rahasia",
        entryFee: 5000,
        requiredLevel: 5,
        background: "linear-gradient(135deg, #00b4d8, #0077b6)",
        color: "#00b4d8",
        bossIds: [101, 102, 103] // ID bos yang bisa muncul
    },
    {
        id: 2,
        name: "🕳️ Gua Kegelapan",
    ...
    },
    {
        id: 3,
        name: "🌋 Jurang Maut",
        description: "Jurang terdalam di lautan, tempat bersemayam monster purba",
        entryFee: 20000,
        requiredLevel: 15,
    ...
    },
    {
        id: 4,
        name: "👑 Throne of Gods",
        description: "Dungeon terakhir, tempat para dewa laut bersemayam",
        entryFee: 50000,
        requiredLevel: 20,
...
// ==================== UPDATED: EXCHANGE RECIPES + ONE RING ====================
const exchangeRecipes = [
    {
        ...
        output: { type: "fish", id: 111, name: "Rahata Turtle", emoji: "🐢", quantity: 1 }
    },
    {
        id: 2,
        ...
        output: { type: "fish", id: 408, name: "1x1x1 Fish", emoji: "💠", quantity: 1 }
    },
    {
        id: 3,
        ...
        output: { type: "fish", id: 409, name: "Elshark Gran Maja", emoji: "🎃", quantity: 1 }
    },
    {
        id: 4,
        ...
        output: { type: "rod", id: 12, name: "GhostFinn Rod", luck: 10000, emoji: "👻", quantity: 1 }
    },
    {
        id: 5,
        ...
        output: { type: "diamond", quantity: 250, emoji: "💎" }
    },
    {
        id: 6,
    ...
    },
    {
        ...
        output: { type: "diamond", quantity: 10, emoji: "💎" }
    },
    {
        id: 8,
        ...
        output: { type: "coin", quantity: 200, emoji: "💰" }
    },
    {
        id: 9,
        name: "Satoshi Rod",
        ...
        output: { type: "rod", id: 14, name: "Satoshi Rod", luck: 20000, emoji: "₿", quantity: 1 }
    },
    {
        id: 10,
        name: "Vitalik Bait",
        ...
        output: { type: "bait", id: 10, name: "Vitalik Bait", luck: 8000, emoji: "💎", quantity: 1 }
    },
    // NEW: One Ring Exchange
    {
        id: 11,
        name: "💍 One Ring",
        ...
        output: { type: "special", id: "oneRing", name: "One Ring", emoji: "💍", quantity: 1 }
    }
];
...
const rankData = {
    ...
    Immortal: {
        ...
        emoji: "👑",
        opponents: [
            { name: "Poseidon", fish: { price: 500000, emoji: "🔱" } },
            { name: "Cthulhu Ancient", fish: { price: 750000, emoji: "👹" } },
            { name: "God of Sea", fish: { price: 1000000, emoji: "🌊" } }
        ]
    }
};
...
function checkDungeonUnlock() {
    ...
    const hasOneRing = gameData.dungeon.specialItems.oneRing;
    
    gameData.dungeon.unlocked = hasGhostShip && hasOneRing;
    
    // Update UI dungeon button if exists
    ...
    if (dungeonBtn) {
        if (gameData.dungeon.unlocked) {
            ...
            dungeonBtn.title = "Butuh Ghost Ship (500💎) + One Ring (10 Secret Fish)";
        }
    }
...
// Load dungeon shop (armor & weapons)
function loadDungeonShop() {
    ...
    dungeonWeapons.forEach(weapon => {
        const isOwned = gameData.dungeon.fishEquipment.weapon === weapon.id;
        ...
        const buyBtn = weaponCard.querySelector('.buy-weapon-btn');
        if (buyBtn && !isOwned && canAfford) {
            buyBtn.addEventListener('click', () => buyDungeonWeapon(weapon));
        }
    ...
    dungeonArmors.forEach(armor => {
        const isOwned = gameData.dungeon.fishEquipment.armor === armor.id;
        ...
        const buyBtn = armorCard.querySelector('.buy-armor-btn');
        if (buyBtn && !isOwned && canAfford) {
            buyBtn.addEventListener('click', () => buyDungeonArmor(armor));
        }
...
function buyDungeonWeapon(weapon) {
...
function buyDungeonArmor(armor) {
...
// Load karakter (pilih ikan untuk dungeon)
function loadDungeonCharacter() {
    const charContainer = document.getElementById('dungeon-character');
    ...
    if (secretFish.length === 0) {
        charContainer.innerHTML = `
            <div style="text-align: center; padding: 30px; background: rgba(255,255,255,0.05); border-radius: 10px;">
                ...
                <p style="color: #00ffff;">Dapatkan ikan Secret dari memancing atau Gacha!</p>
            </div>
        `;
        return;
    }
    
    // Stats dari ikan yang dipilih
    const equippedFishIndex = gameData.dungeon.fishEquipment.equippedFish;
    const equippedFish = equippedFishIndex !== null ? gameData.backpack[equippedFishIndex] : null;
    
    // Hitung stats
    let hp = 0, attack = 0, defense = 0;
    
    if (equippedFish) {
        // HP = price tanpa 0 di belakang
        hp = Math.floor(equippedFish.price / 10);
        
        // Attack dari weapon
        const weapon = dungeonWeapons.find(w => w.id === gameData.dungeon.fishEquipment.weapon);
        attack = weapon ? weapon.attack : 0;
        ...
        fishOptions += `
            <div onclick="selectDungeonFish(${fishIndex})" 
                ...
                <div style="flex: 1;">
                    ...
                    <div style="color: #4CAF50;">❤️ HP: ${Math.floor(fish.price / 10)}</div>
                </div>
    ...
    charContainer.innerHTML = `
        <div style="background: rgba(0,0,0,0.3); border-radius: 10px; padding: 20px;">
            <h3 style="color: #FFD700; margin-bottom: 20px;">🐟 Pilih Ikan untuk Bertarung</h3>
            
            ${equippedFish ? `
            <div style="background: linear-gradient(135deg, #4a00e0, #8e2de2); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                <h4 style="color: white; margin-bottom: 15px;">IKAN TERPILIH:</h4>
                <div style="display: flex; align-items: center; gap: 20px;">
                    <div style="font-size: 4rem;">${equippedFish.emoji}</div>
                    <div>
                        <div style="color: #FFD700; font-size: 1.5rem;">${equippedFish.name}</div>
                        <div style="color: #4CAF50;">❤️ HP: ${hp}</div>
                        <div style="color: #ff6b6b;">⚔️ Attack: ${attack}</div>
                        <div style="color: #4CAF50;">🛡️ Defense: ${defense}</div>
                    </div>
                </div>
            </div>
            ` : `
            <div style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 10px; margin-bottom: 20px; text-align: center;">
                <p style="color: #FF6B6B;">Belum ada ikan yang dipilih! Pilih ikan di bawah.</p>
            </div>
            `}
            
            <h4 style="color: #00ffff; margin-bottom: 10px;">Daftar Ikan Secret Kamu:</h4>
...
function selectDungeonFish(fishIndex) {
    ...
    if (!fish || (fish.rarity !== 'secret' && fish.rarity !== 'special')) {
        showNotification("❌ Hanya ikan Secret yang bisa dipilih!", "error");
        return;
    }
    
    gameData.dungeon.fishEquipment.equippedFish = fishIndex;
    showNotification(`✅ ${fish.name} siap bertarung!`, "success");
    
    loadDungeonCharacter();
    loadDungeonLevels();
}

// Load daftar level dungeon
function loadDungeonLevels() {
    const levelsContainer = document.getElementById('dungeon-levels');
...
function enterDungeonLevel(levelId) {
    ...
    // Pilih bos random dari level ini
    ...
    const playerHP = Math.floor(fish.price / 10);
    ...
    // Tampilkan battle modal
    showDungeonBattle();
}

function showDungeonBattle() {
    ...
    battleContent.innerHTML = `
        <div style="padding: 20px;">
            ...
            <div style="display: flex; justify-content: space-between; gap: 20px; margin-bottom: 30px;">
                ...
                <div style="flex: 1; background: rgba(0,0,0,0.3); padding: 20px; border-radius: 10px; text-align: center;">
                    ...
                    <div style="margin: 15px 0;">
                        <div style="color: #4CAF50;">❤️ HP: ${battle.playerHP}/${battle.playerMaxHP}</div>
                        <div style="width: 100%; height: 10px; background: rgba(255,255,255,0.2); border-radius: 5px; margin-top: 5px;">
                            <div style="width: ${(battle.playerHP/battle.playerMaxHP)*100}%; height: 100%; background: #4CAF50; border-radius: 5px;"></div>
                        </div>
                    </div>
                ...
                <div style="flex: 1; background: rgba(255,0,0,0.1); padding: 20px; border-radius: 10px; text-align: center;">
                    ...
                    <div style="margin: 15px 0;">
                        <div style="color: #4CAF50;">❤️ HP: ${battle.bossHP}/${battle.bossMaxHP}</div>
                        <div style="width: 100%; height: 10px; background: rgba(255,255,255,0.2); border-radius: 5px; margin-top: 5px;">
                            <div style="width: ${(battle.bossHP/battle.bossMaxHP)*100}%; height: 100%; background: #ff6b6b; border-radius: 5px;"></div>
                        </div>
                    </div>
            ...
            <div style="text-align: center; margin: 20px 0;">
                <p style="color: #ccc;">Giliran: <span style="color: ${battle.playerTurn ? '#00ffff' : '#FF6B6B'};">${battle.playerTurn ? 'Giliranmu' : 'Giliran Boss'}</span></p>
            </div>
            
            <div style="display: flex; gap: 15px; justify-content: center;">
                <button onclick="dungeonAttack()" ${!battle.playerTurn ? 'disabled' : ''}
...
function dungeonAttack() {
    ...
    setTimeout(() => {
        if (!gameData.dungeon.battleInProgress) return;
        
        // Boss attack player
        let bossDamage = Math.max(1, battle.bossAttack - battle.playerDefense + Math.floor(Math.random() * 15));
        battle.playerHP -= bossDamage;
        
        showNotification(`💢 Boss menyerang! Damage: ${bossDamage}`, "error");
...
function dungeonVictory() {
    ...
    if (allBossesDefeated) {
        ...
        showNotification(`🎉 SELESAI! +100 💎 + ${randomSecret.name}!`, "success");
    } else {
        ...
        showNotification(`🎉 Mengalahkan ${battle.boss.name}! +${battle.boss.reward.coins}🪙 +${battle.boss.reward.exp} EXP`, "success");
    }
...
function switchToDungeon() {
    ...
    if (!checkDungeonUnlock()) {
        showNotification("❌ Butuh Ghost Ship (500💎) + One Ring (10 Secret Fish) untuk buka dungeon!", "error");
        return;
    }
    
    // Sembunyikan main menu, tampilkan dungeon menu
    document.getElementById('main-menu').style.display = 'none';
    document.getElementById('dungeon-menu').style.display = 'block';
    
    // Load semua komponen dungeon
    loadDungeonCharacter();
    loadDungeonShop();
    loadDungeonLevels();
}
...
function exchangeItems(recipe) {
    ...
    if (recipe.output.type === "fish") {
        ...
        gameData.dungeon.specialItems.oneRing = true;
        showNotification(`💍 SELAMAT! Kamu mendapatkan One Ring! Sekarang cari Ghost Ship untuk buka dungeon!`, "success");
    }
...
function initGame() {
    ...
    showNotification("🎮 Game loaded successfully! Dungeon Update v5!", "success");
}
...
function setupEventListeners() {
    ...
    window.addEventListener('click', (e) => {
        ...
        if (dungeonModal && e.target === dungeonModal) dungeonModal.style.display = 'none';
...
window.dungeonAttack = dungeonAttack;
window.dungeonFlee = dungeonFlee;
...
style.textContent = `
    ...
    /* Dungeon Tabs */
    .dungeon-tab.active { background: #FFD700 !important; color: #000 !important; }
    .dungeon-pane { display: none; }
    .dungeon-pane.active { display: block; }
`;
