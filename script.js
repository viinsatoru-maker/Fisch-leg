...
const gameData = {
    ...
    // Atlantis sekarang permanen
    atlantis: {
        active: true, // Selalu aktif
        spotId: 7
    },
    favoriteFish: [],
    ...
    // ==================== NEW: DUNGEON SYSTEM ====================
    dungeon: {
        unlocked: true, // Selalu terbuka (gak pake syarat)
        fishEquipment: {
            equippedFish: null, // Index ikan di backpack
...
const fishingSpots = [
    ...
    },
    {
        ...
        color: "#F7931A",
        // UPDATED: Turunkan chance Binance & Ethereum
        fishes: [
...
// ==================== ATLANTIS SPOT (PERMANEN) ====================
const atlantisSpot = {
    id: 7,
    name: "🌊 Atlantis",
    background: "linear-gradient(135deg, #00ffff, #006994, #000080)",
    color: "#00ffff",
    isEventSpot: false, // Sekarang permanen
    fishes: [
...
// ==================== NEW: DUNGEON WEAPONS & ARMOR ====================
const dungeonWeapons = [
    { id: 1, name: "Pisau Karang", attack: 10, price: 2000, currency: "coins", emoji: "🔪", description: "Senjata basic +10 ATK" },
    { id: 2, name: "Tombak Nelayan", attack: 25, price: 5000, currency: "coins", emoji: "🔱", description: "Tombak tajam +25 ATK" },
    { id: 3, name: "Pedang Laut", attack: 50, price: 15000, currency: "coins", emoji: "⚔️", description: "Pedang bertenaga ombak +50 ATK" },
    { id: 4, name: "Trident Emas", attack: 100, price: 50, currency: "diamonds", emoji: "🔱✨", description: "Senjata legendaris +100 ATK" },
    { id: 5, name: "Excalibur Ikan", attack: 250, price: 200, currency: "diamonds", emoji: "🗡️👑", description: "Senjata terkuat +250 ATK" }
];

const dungeonArmors = [
    { id: 1, name: "Baju Sisik", defense: 5, price: 1500, currency: "coins", emoji: "🛡️", description: "Armor sisik +5 DEF" },
    { id: 2, name: "Zirah Kerang", defense: 15, price: 4000, currency: "coins", emoji: "🐚", description: "Perlindungan kerang +15 DEF" },
    { id: 3, name: "Baju Baja", defense: 30, price: 10000, currency: "coins", emoji: "🛡️⚙️", description: "Armor baja kokoh +30 DEF" },
    { id: 4, name: "Jubah Hantu", defense: 60, price: 40, currency: "diamonds", emoji: "👻", description: "Jubah misterius +60 DEF" },
    { id: 5, name: "Armor Naga", defense: 150, price: 150, currency: "diamonds", emoji: "🐲🛡️", description: "Armor legendaris +150 DEF" }
];
...
const dungeonBosses = [
    ...
    // LEVEL 4 DUNGEON (BOSS BESAR - REQUEST)
    {
        id: 401,
        name: "Morgoth",
        emoji: "👑🔥",
...
// ==================== UPDATED: FISHING SYSTEM dengan pengecekan item ====================
...
// ==================== UPDATED: startFishing dengan pengecekan ====================
...
function processBattleResult(isWin, fish, winChance) {
    ...
    if (isWin) {
        ...
        showNotification(`🎉 MENANG! +${rankInfo.winReward.diamonds + bonusDiamonds} 💎 (termasuk bonus streak)`, "success");
...
// ==================== NEW: DUNGEON FUNCTIONS ====================

// Dungeon variables
let currentDungeonLevel = null;
...
function loadDungeonCharacter() {
    ...
    // Hitung stats ikan yang dipilih
    let statsHTML = '';
    if (equippedFishIndex !== null && gameData.backpack[equippedFishIndex]) {
        const fish = gameData.backpack[equippedFishIndex];
        const hp = Math.floor(fish.price / 10);
        ...
        const attack = weapon ? weapon.attack : 0;
        ...
        statsHTML = `
            <div style="background: linear-gradient(135deg, #4a00e0, #8e2de2); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                ...
                <div style="display: flex; align-items: center; gap: 20px;">
                    ...
                    <div>
                        <div style="color: #FFD700; font-size: 1.5rem;">${fish.name}</div>
                        <div style="color: #4CAF50;">❤️ HP: ${hp}</div>
                        <div style="color: #ff6b6b;">⚔️ Attack: ${attack} ${weapon ? `(${weapon.name})` : '(Tanpa senjata)'}</div>
                        <div style="color: #4CAF50;">🛡️ Defense: ${defense} ${armor ? `(${armor.name})` : '(Tanpa armor)'}</div>
                    </div>
                </div>
            </div>
        `;
...
function enterDungeonLevel(levelId) {
    ...
    // Simpan current dungeon level dan boss
...
function startDungeonBattle() {
    if (!currentBoss || !currentDungeonLevel) return;
    ...
    // Set battle state di gameData
    gameData.dungeon.currentBattle = {
        levelId: currentDungeonLevel.id,
        boss: currentBoss,
        ...
        bossAttack: currentBoss.attack,
        bossDefense: currentBoss.defense,
        playerTurn: true
    };
...
function dungeonVictory() {
    ...
    if (allBossesDefeated) {
        ...
        showNotification(`🎉 DUNGEON SELESAI! +100 💎 + ${randomSecret.name}!`, "success");
    }
