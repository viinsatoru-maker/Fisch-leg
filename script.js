...
function finishFishing(fish, perfectCatch = false) {
    ...
    gameData.exp = Number(gameData.exp) + 10;
    checkLevelUp();
...
// ==================== EXCHANGE SYSTEM dengan ONE RING (FIX BUG) ====================
...
function dungeonVictory() {
    ...
    gameData.coins = Number(gameData.coins) + Number(battle.boss.reward.coins);
    gameData.exp = Number(gameData.exp) + Number(battle.boss.reward.exp);
    checkLevelUp();
